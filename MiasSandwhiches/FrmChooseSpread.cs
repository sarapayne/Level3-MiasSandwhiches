...
{
    public partial class FrmChooseSpread : FrmBaseSandwichChoices
    {
        /*
     ...
     * Finally if its allowed the continue button closes this form and opens Choose Sauce.
    */

        public FrmChooseSpread()
        {
            InitializeComponent();
        }

        private void FrmChooseSpread_Load(object sender, EventArgs e)
        {
            base.ActiveMainCatagory = "Spread";//sets this on the inherited value
        ...
        public override void BtnContinue_Click(object sender, EventArgs e)
        {
            ...
            {//if continue is allowed close this form and open choose sauce
                FrmChooseSauce frmChooseSauce = new FrmChooseSauce();
                this.Hide();
                frmChooseSauce.ShowDialog();
                this.Close();
            }
        }
