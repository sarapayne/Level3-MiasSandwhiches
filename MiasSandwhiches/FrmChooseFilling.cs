...
{
    public partial class FrmChooseFilling : FrmBaseSandwichChoices
    {
        /*
     ...
     * Finally if its allowed the continue button closes this form and opens Choose Salad.
    */

        public FrmChooseFilling()
        {
            InitializeComponent();
        }

        private void FrmChooseFilling_Load(object sender, EventArgs e)
        {
            base.ActiveMainCatagory = "Filling";//sets this on the inherited value
        ...
        public override void BtnContinue_Click(object sender, EventArgs e)
        {
            ...
            {//if continue is allowed close this form and open choose salad
                SendCat3ToStorageClass();
                FrmChooseSalad frmChooseSalad = new FrmChooseSalad();
                this.Hide();
                frmChooseSalad.ShowDialog();
                this.Close();
            }
        }
